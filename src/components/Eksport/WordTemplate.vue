  ...
  <div>
    <div class="document_container" id="exportContent">
      ...
      <body style="padding: 0; margin-top:-20pt">
        <table class="table" cellpadding="0" cellspacing="0" style="
                margin-left:-25.5pt;
                margin-top: 0in;
          ...
          <tbody>
            ...
            <tr style="font-size: 14.5px">
              <td colspan="8">
                <b>Xalq deputatlari respublika, viloyat, shahar va tuman
            ...
            <tr v-for="item in cadry.carers" :key="item.id" style="font-size: 14.5px; margin-bottom: 4pt">
        ...
        <b><span><br clear="all" style="page-break-before: always" /> </span></b>
