<template>
  ...
  class="border-1 border-red-500   page-content"
>
<DataTable :value="products" :resizableColumns="true" columnResizeMode="fit" class="max_table" showGridlines responsiveLayout="scroll">
