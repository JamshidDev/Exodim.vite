<template>
  <div class="grid  py-4 px-1">
        ...
        <div class="col-12">
          <div class="w-full flex justify-content-between align-items-center">
            <Button
              ...
              @click="goPush()"
              class="p-button-secondary p-button-rounded p-button-sm p-1 text-sm "
    ...
    <div class="col-12">
      <translate-modal ref="translate_refs"></translate-modal>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    translateToLotin(){
      this.$refs.translate_refs.controlModal(true, this.$route.params.id);
    }
  },
